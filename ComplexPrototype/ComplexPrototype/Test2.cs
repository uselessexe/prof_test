...
namespace ComplexPrototype
{
    public partial class Test2 : Form
    {
        ...
        int i;
        int UserID;
        public Test2(NpgsqlConnection con, int UserID)
        {
            InitializeComponent();
            this.con = con;
            this.UserID = UserID;
        ...
        private void Test2_Load(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                NpgsqlDataAdapter DA = new NpgsqlDataAdapter($"SELECT * FROM \"Question\" q JOIN \"Answer\" a on (a.\"QuestionID\"=q.\"QuestionID\") WHERE \"TestID\" = 2", con);
        ...
        private void EndTest()
        {
            ...
            {
                con.Open();
                NpgsqlDataAdapter DA = new NpgsqlDataAdapter($"SELECT * FROM \"Result\" WHERE \"TestID\" = 2 ", con);
                ...
                NpgsqlCommand cmd = new NpgsqlCommand($"INSERT INTO \"ResultHistory\"(\"UserID\",\"Date\",\"TestID\",\"Statistics\")" +
                        $" VALUES('{UserID}','{DateTime.Now}',{2},'{ResultList}')", con);
                cmd.ExecuteNonQuery();
